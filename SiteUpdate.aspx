<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SiteUpdate.aspx.cs"  Inherits="SiteUpdate" %>
...
<!--
    function toggle_visibility(id) 
    {
        ...
        var val= document.getElementById("drpStatus").value
       //alert(val);
       if(val == '6')
    ...
    <table  border=1 >
        ...
        <tr>
            <td >
                Status</td>
            <td>
                <asp:DropDownList ID="drpStatus" CssClass="tb2" onclick="toggle_visibility('dateDiv');"
                DataTextField="StatusShortDesc" DataValueField="StatusId"
                 runat="server">
                </asp:DropDownList>
            </td>
            <td>
        ...
        <tr>
            <td >
                Scheduled for Date </td>
            <td>
             <div id="dateDiv">
                <input  type="text" class="tb2" runat="server"  name="dd" id="calander" onClick="getDateString(this,oCalendarEn)" >
               </Div>  
                </td>
            <td>
               <%=_strDate%> </td>
        ...
        <tr>
            <td >
                Dest Server Type</td>
            <td>
                <asp:DropDownList ID="drpServerType" CssClass="tb2" DataTextField="DestData" DataValueField="Id" runat="server">
                </asp:DropDownList>
            </td>
            <td> <%=_strDestType%>
                </td>
        ...
        <tr>
            <td >
                Environment</td>
            <td>
                <asp:DropDownList ID="drpEnv" CssClass="tb2" DataTextField="DestData" 
                    DataValueField="Id" runat="server" Enabled=false>
                </asp:DropDownList>
            </td>
            <td>
                <%=_strEnv%></td>
        ...
        <tr>
            <td >
                Comment</td>
            <td>
                <asp:TextBox ID="txtComment" runat="server" TextMode=MultiLine CssClass="textInput2"></asp:TextBox>
            </td>
            <td>
               <%=_strComment %></td>
        </tr>
